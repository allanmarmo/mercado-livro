package br.com.webmarmo.mercadolivro.security

import br.com.webmarmo.mercadolivro.exception.AuthenticationException
...
class AuthorizationFilter(
    ...
    private fun getAuthentication(token: String): UsernamePasswordAuthenticationToken {
        ...
        val subject = jwtUtil.getSubject(token = token)
